                    ...
                    <table>
                        <tr>
                           <td><a id="cal" onclick="calMultiTrajs()" href="calMultiTrajs.action"  class="white">
                           	<button class="btn btn-primary" id="btnCal">开始计算</button>
                           </a></td>
                           <td><select>
...
<script type="text/javascript">
	var aresult="${actionResult}";
	if(aresult=="error"){
		alert("数据类型错误！！");
		$("#btnCal").attr("disabled",true);
	}else if(aresult=="input"){
		alert("文件类型错误！！");
		$("#btnCal").attr("disabled",true);
	}
	...
	var hasTime="${hasTimestamp}";

	$(document).ready(function () {
		drawTraj(strTrajs,allTrajs,hasTime);			
